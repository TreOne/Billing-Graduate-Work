...
if __name__ == '__main__':
    ...
    user_auth_service = DummyAuthAPI({
        'a19236ca-2c39-4353-bd82-8b1ea3e59610': UserSchema(email='user@example.com', username='ExampleUser'),
        'a19236ca-2c39-4353-bd82-8b1ea3e59611': UserSchema(email='user2@example.com', username='ExampleUser2'),
    })
